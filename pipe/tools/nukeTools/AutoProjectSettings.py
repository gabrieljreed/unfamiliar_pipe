"""
Shamelessly copied from Cenote's pipe.
https://github.com/smartins1234/BYU_anm_pipeline/blob/master/pipe/tools/nukeTools/AutoProjectSettings.py
"""
import os
...
def AutoProjectSettings():
	...
	# Input variables
	readFile = env.Environment().get_shot_dir()
