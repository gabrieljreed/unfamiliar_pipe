...
class BuildShader():
    ...
    def DefineAssetInfo(self):
        ...
        #UDIMs?
        #I'm sure there is a better way to do this but alas we have no time
    ...
    def ShaderBuild(self):
        ...
        if(self.purpose == "prod"):
            ...
            pxrSurface = matLib.createNode("pxrsurface",self.shaderName)
        ...
        hou.ui.displayMessage("Finished building shader for " +self.shaderName+".",buttons=("Okay",),title="Success!")

myBuildShader = BuildShader(purpose="prod",prefix="pxr_",identifier="DiffuseColor",
        UDIMs=False,fileFormat=".png",filePath="no filepath",shaderName="book_fire_shelf_mid_a")
myBuildShader.DefineAssetInfo()
myBuildShader.ShaderBuild()